...
echo -e "Preparing to copy generated files"
if [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_BRANCH" == "master" ]; then
    ...
    git clone --quiet --branch=master --single-branch https://${GH_TOKEN}@github.com/pinga-lab/pinga-lab.github.io.git website > /dev/null
    cd website
